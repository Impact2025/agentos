...
:start
echo Start ImpactOS op 1250...
set "PYTHONIOENCODING=utf-8"
start "" /b "D:\APPS\agentos\.venv\Scripts\uvicorn.exe" backend.main:app --host localhost --port 1250 >> "D:\APPS\agentos\logs\impactos_restart.log" 2>&1
echo Gestart.
