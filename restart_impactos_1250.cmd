@echo off
rem ============================================================
rem  ImpactOS (port 1250) herstarten — VOOR KNOWLEDGE FORGE (/api/learn)
rem  Dubbelklik dit bestand OF run: restart_impactos_1250.cmd
rem  (Hermes Agent mag dit niet zelf uitvoeren wegens taskkill-blokkade)
rem ============================================================
cd /d D:\APPS\agentos

echo [1/3] Zoek draaiende ImpactOS op poort 1250...
...
:start
echo [3/3] Start ImpactOS op 1250...
